...
env.workspace = r'D:\Clark_County_2017_ImageClassification_Project\Samples_models\book_126_models\book_126.gdb'
env.overwriteOutput = True



#defines the output for the separated out vegetation types
TreeOutput = r'D:\Clark_County_2017_ImageClassification_Project\Samples_models\book_126_models\book_126_Tree.gdb'
TurfOutput = r'D:\Clark_County_2017_ImageClassification_Project\Samples_models\book_126_models\book_126_Turf.gdb'
...
parcels = r'D:\Clark_County_2017_ImageClassification_Project\processing_Data.gdb\GISDBA_Parcels'

parcels_aox = r'D:\Clark_County_2017_ImageClassification_Project\processing_Data.gdb\GISDBA_PARCELS_AOX'
...
ScratchOutput = r'D:\Clark_County_2017_ImageClassification_Project\Samples_models\book_126_models\Scratch.gdb'
...
for fc in fcs:
    ...
    arcpy.FeatureClassToFeatureClass_conversion('lyr2', ScratchOutput2, fc)


    #delete any unnecessary fields from the fc in the ScratchOutput2 gdb
    arcpy.DeleteField_management(ScratchOutput2 + '\\' + fc, dropfields)


    #split up the turf and tree from the second scratch gdb and place them into separate gdbs based on veg type
    arcpy.MakeFeatureLayer_management(ScratchOutput2 + '\\' + fc, 'lyr3')
