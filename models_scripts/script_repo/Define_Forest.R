...
imagery <- brick("D:/Clark_County_2017_ImageClassification_Project/Samples_models/book_162_models/rfModel/samplemosaic.img")

#Grab the shapefile samples using OGR
training_samples <- readOGR("D:/Clark_County_2017_ImageClassification_Project/Samples_models/book_162_models/rfModel/Samples.shp", 'Samples')
...
write.csv(roi_data, 'D:/Clark_County_2017_ImageClassification_Project/Samples_models/book_162_models/rfModel/Book162Model.csv')

#read the previously exported csvdata
intable <- read.csv('D:/Clark_County_2017_ImageClassification_Project/Samples_models/book_162_models/rfModel/Book162Model.csv')
...
saveRDS(myrf2, 'D:/Clark_County_2017_ImageClassification_Project/Samples_models/book_162_models/rfModel/Book162Model.rds')
