...
ws = r'D:\Clark_County_2017_ImageClassification_Project\Samples_models\book_126_models\test\book_126_Turf.gdb'
env.workspace = ws
...
output = r"D:\Clark_County_2017_ImageClassification_Project\Samples_models\book_126_models\test\TurfTest.gdb"
output2 = r'D:\Clark_County_2017_ImageClassification_Project\Samples_models\book_126_models\test\Final_136_Turf.gdb'
...
for fc in fcs:
    ...
    #arcpy.Dissolve_management('fclyr', output + '\\' + fc, [fc[:-4] + 'APN', 'YARD'])
    ...
    arcpy.AddField_management('FinalOut', '')
